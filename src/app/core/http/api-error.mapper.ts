...
const KNOWN_MESSAGES: Readonly<Record<string, string>> = {
  ...
  SERVICE_CATEGORY_NOT_FOUND: 'The service category could not be found.',
  SERVICE_CATEGORY_NAME_EXISTS: 'A service category with this name already exists.',
  SERVICE_NOT_FOUND: 'The service could not be found in the active organization.',
  SERVICE_NAME_EXISTS: 'A service with this name already exists in the active organization.',
  SPECIALIST_NOT_FOUND: 'The specialist could not be found in the active organization.',
  SPECIALIST_USER_NOT_FOUND: 'The selected user is not an active member of this organization.',
  SPECIALIST_USER_EXISTS: 'This user is already linked to another specialist.',
  AVAILABILITY_NOT_FOUND: 'The availability window could not be found.',
  SCHEDULE_BLOCK_NOT_FOUND: 'The schedule block could not be found.',
  SCHEDULE_OVERLAP: 'This availability overlaps an existing active schedule.',
  CUSTOMER_NOT_FOUND: 'The customer could not be found in the active organization.',
  APPOINTMENT_NOT_FOUND: 'The appointment could not be found in the active organization.',
  SLOT_NOT_AVAILABLE: 'That time is no longer available. Select another time.',
  APPOINTMENT_CONFLICT: 'That time is no longer available. Select another time.',
  INVALID_APPOINTMENT_TRANSITION: 'This appointment cannot be changed from its current status.',
  RESOURCE_CONFLICT: 'An identical availability window already exists.',
